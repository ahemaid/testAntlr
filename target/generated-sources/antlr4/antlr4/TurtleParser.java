...
public class TurtleParser extends Parser {
	...
	public static final String[] tokenNames = {
		"<INVALID>", "'@BASE'", "'^^'", "';'", "'['", "'{'", "']'", "'}'", "'='", 
		"'^'", "'\"'", "'('", "')'", "','", "'.'", "KW_BASE", "KW_PREFIX", "'true'", 
		"'false'", "PASS", "COMMENT", "'@base'", "'@prefix'", "CODE", "'a'", "IRIREF", 
	...
	public final StartContext start() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__13) | (1L << KW_BASE) | (1L << KW_PREFIX) | (1L << BASE) | (1L << PREFIX))) != 0)) {
				{
				{
				setState(56); directive();
				}
				}
				setState(61);
				_errHandler.sync(this);
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__10) | (1L << T__9) | (1L << T__4) | (1L << T__3) | (1L << KW_TRUE) | (1L << KW_FALSE) | (1L << IRIREF) | (1L << PNAME_NS) | (1L << PNAME_LN) | (1L << BLANK_NODE_LABEL) | (1L << INTEGER) | (1L << DECIMAL) | (1L << DOUBLE) | (1L << STRING_LITERAL1) | (1L << STRING_LITERAL2) | (1L << STRING_LITERAL_LONG1) | (1L << STRING_LITERAL_LONG2))) != 0)) {
				{
				{
				setState(76); errors();
				}
	...
	public final BaseSparqlContext baseSparql() throws RecognitionException {
		...
		try {
			...
			case 4:
				...
				{
				setState(99); match(KW_BASE);
				setState(100); match(IRIREF);
	...
	public final BaseContext base() throws RecognitionException {
		...
		try {
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(108); match(BASE);
				setState(109); match(IRIREF);
	...
	public final PrefixContext prefix() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(119); match(PREFIX);
				setState(120); match(PNAME_NS);
				setState(121); match(IRIREF);
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(123); match(PREFIX);
				setState(124); match(PNAME_NS);
				setState(125); match(IRIREF);
	...
	public final PrefixSparqlContext prefixSparql() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(136); match(KW_PREFIX);
				setState(137); ((PrefixSparqlContext)_localctx).PNAME_NS = match(PNAME_NS);
				setState(138); ((PrefixSparqlContext)_localctx).IRIREF = match(IRIREF);
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(140); match(KW_PREFIX);
				setState(141); match(PNAME_NS);
				setState(142); match(IRIREF);
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(145); match(KW_PREFIX);
				setState(146); match(PNAME_NS);
	...
	public final TriplesContext triples() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(172); subject();
				setState(173); predicateObjectList();
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(176); subject();
				setState(177); predicateObjectList();
				setState(179); 
				_errHandler.sync(this);
				_alt = 1;
				do {
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(190); subject();
				setState(191); predicateObjectList();
	...
	public final BlankContext blank() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(209); blankNode();
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(210); blankNodePropertyList();
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(211); collection();
				}
				break;
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(212); blankNode();
	...
	public final BlankNodePropertyListContext blankNodePropertyList() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__10) | (1L << T__4) | (1L << T__3) | (1L << KW_TRUE) | (1L << KW_FALSE) | (1L << RDF_TYPE) | (1L << IRIREF) | (1L << PNAME_NS) | (1L << PNAME_LN) | (1L << BLANK_NODE_LABEL) | (1L << INTEGER) | (1L << DECIMAL) | (1L << DOUBLE) | (1L << STRING_LITERAL1) | (1L << STRING_LITERAL2) | (1L << STRING_LITERAL_LONG1) | (1L << STRING_LITERAL_LONG2))) != 0)) {
				{
				{
				setState(219); predicateObjectList();
				}
				}
				setState(224);
				_errHandler.sync(this);
	...
	public final PredicateObjectListContext predicateObjectList() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(227); predicate();
				setState(228); objectList();
				setState(235);
				_errHandler.sync(this);
	...
	public final CollectionContext collection() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__10) | (1L << T__4) | (1L << T__3) | (1L << KW_TRUE) | (1L << KW_FALSE) | (1L << IRIREF) | (1L << PNAME_NS) | (1L << PNAME_LN) | (1L << BLANK_NODE_LABEL) | (1L << INTEGER) | (1L << DECIMAL) | (1L << DOUBLE) | (1L << STRING_LITERAL1) | (1L << STRING_LITERAL2) | (1L << STRING_LITERAL_LONG1) | (1L << STRING_LITERAL_LONG2))) != 0)) {
				{
				{
				setState(260); object();
				}
	...
	public final RdfLiteralContext rdfLiteral() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				case LANGTAG:
					{
					setState(300); match(LANGTAG);
					}
					break;
				case T__12:
					{
					setState(301); match(T__12);
					setState(302); datatype();
					}
					break;
				case EOF:
				case T__11:
			...
			case 2:
				...
				case LANGTAG:
					{
					setState(306); match(LANGTAG);
					}
					break;
				case T__5:
					{
					setState(307); match(T__5);
					setState(308); datatype();
					}
					break;
				case EOF:
				case T__11:
	...
	public final StringContext string() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(317); match(STRING_LITERAL_LONG1);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(318); match(STRING_LITERAL_LONG2);
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(319); match(STRING_LITERAL_LONG2);
			...
			case 4:
				...
				setState(323); match(STRING_LITERAL_LONG2);
				notifyErrorListeners("Uncorrect form of long literal with 4 qoutes");
				}
				break;
			case 5:
				enterOuterAlt(_localctx, 5);
				{
				setState(325); match(STRING_LITERAL1);
				}
				break;
			case 6:
				enterOuterAlt(_localctx, 6);
				{
				setState(326); match(STRING_LITERAL2);
				}
				break;
			}
		}
	...
	public final BlankNodeContext blankNode() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(335); match(BLANK_NODE_LABEL);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static final String _serializedATN =
		...
		"\35\u0173\2=\3\2\2\2\4V\3\2\2\2\6Z\3\2\2\2\bi\3\2\2\2\ns\3\2\2\2\fw\3"+
		"\2\2\2\16\u0088\3\2\2\2\20\u009a\3\2\2\2\22\u00ac\3\2\2\2\24\u00c4\3\2"+
		"\2\2\26\u00d1\3\2\2\2\30\u00da\3\2\2\2\32\u00dc\3\2\2\2\34\u00f6\3\2\2"+
		"\2\36\u00f8\3\2\2\2 \u0103\3\2\2\2\"\u0105\3\2\2\2$\u0111\3\2\2\2&\u011b"+
		...
		"\3\2\2\2\\]\7\21\2\2]j\7\33\2\2^_\7\3\2\2_`\7\33\2\2`a\7\20\2\2aj\b\5"+
		"\1\2bc\7\3\2\2cd\7\33\2\2dj\b\5\1\2ef\7\21\2\2fg\7\33\2\2gh\7\20\2\2h"+
		"j\b\5\1\2i\\\3\2\2\2i^\3\2\2\2ib\3\2\2\2ie\3\2\2\2j\t\3\2\2\2kl\7\27\2"+
		"\2lm\7\33\2\2mt\7\20\2\2no\7\27\2\2op\7\33\2\2pt\b\6\1\2qr\7\27\2\2rt"+
		"\b\6\1\2sk\3\2\2\2sn\3\2\2\2sq\3\2\2\2t\13\3\2\2\2ux\5\20\t\2vx\5\16\b"+
		"\2wu\3\2\2\2wv\3\2\2\2x\r\3\2\2\2yz\7\30\2\2z{\7\34\2\2{|\7\33\2\2|\u0089"+
		"\7\20\2\2}~\7\30\2\2~\177\7\34\2\2\177\u0080\7\33\2\2\u0080\u0089\b\b"+
		"\1\2\u0081\u0082\7\30\2\2\u0082\u0083\7\34\2\2\u0083\u0089\b\b\1\2\u0084"+
