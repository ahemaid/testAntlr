...
public class TurtleParser extends Parser {
	...
	public static final String[] tokenNames = {
		"<INVALID>", "'@keywords'", "'@BASE'", "'^^'", "';'", "'['", "'{'", "']'", 
		"'}'", "'='", "'^'", "'<='", "'\"'", "'('", "')'", "','", "'.'", "KW_BASE", 
		"KW_PREFIX", "'true'", "'false'", "PASS", "COMMENT", "'@base'", "'@prefix'", 
		"CODE", "'a'", "IRIREF", "WRONGIRIREF", "PNAME_NS", "PNAME_LN", "REGEXP", 
		"REGEXP_FLAGS", "BLANK_NODE_LABEL", "LANGTAG", "INTEGER", "DECIMAL", "DOUBLE", 
		"CHAR", "STRING_LITERAL1", "STRING_LITERAL2", "STRING_LITERAL_LONG1", 
		"STRING_LITERAL_LONG2", "WRONG_STRING_LITERAL_LONG2"
	};
	public static final int
	...
	public final StartContext start() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__15) | (1L << T__14) | (1L << KW_BASE) | (1L << KW_PREFIX) | (1L << BASE) | (1L << PREFIX))) != 0)) {
				{
				{
				setState(58); directive();
				}
				}
				setState(63);
				_errHandler.sync(this);
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__11) | (1L << T__10) | (1L << T__4) | (1L << T__3) | (1L << KW_TRUE) | (1L << KW_FALSE) | (1L << IRIREF) | (1L << WRONGIRIREF) | (1L << PNAME_NS) | (1L << PNAME_LN) | (1L << BLANK_NODE_LABEL) | (1L << INTEGER) | (1L << DECIMAL) | (1L << DOUBLE) | (1L << STRING_LITERAL1) | (1L << STRING_LITERAL2) | (1L << STRING_LITERAL_LONG1) | (1L << STRING_LITERAL_LONG2) | (1L << WRONG_STRING_LITERAL_LONG2))) != 0)) {
				{
				{
				setState(78); errors();
				}
	...
	public final DirectiveContext directive() throws RecognitionException {
		...
		try {
			...
			case PREFIX:
				...
				{
				setState(85); prefixDecl();
				}
				break;
			case T__15:
				enterOuterAlt(_localctx, 3);
				{
				setState(86); unkonwnDecl();
				}
				break;
			default:
	...
	public final BaseSparqlContext baseSparql() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(103); match(KW_BASE);
				setState(104); match(IRIREF);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
	...
	public final BaseContext base() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(118); match(BASE);
				setState(119); match(IRIREF);
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(121); match(BASE);
				setState(122); match(IRIREF);
	...
	public final PrefixContext prefix() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(133); match(PNAME_NS);
				setState(134); match(IRIREF);
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(136); match(PREFIX);
				setState(137); match(PNAME_NS);
				setState(138); match(IRIREF);
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(140); match(PREFIX);
				setState(141); match(PNAME_NS);
	...
	public final PrefixSparqlContext prefixSparql() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(149); match(KW_PREFIX);
				setState(150); ((PrefixSparqlContext)_localctx).PNAME_NS = match(PNAME_NS);
				setState(151); ((PrefixSparqlContext)_localctx).IRIREF = match(IRIREF);
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(153); match(KW_PREFIX);
				setState(154); match(PNAME_NS);
				setState(155); match(IRIREF);
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(158); match(KW_PREFIX);
				setState(159); match(PNAME_NS);
			...
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(162); match(KW_PREFIX);
				setState(163); match(IRIREF);
				notifyErrorListeners("Missing NameSpace in Prefix directive");
				}
				break;
			}
	...
	public final ErrorsContext errors() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				setState(174); subject();
				setState(175); predicateObjectList();
	...
	public final TriplesContext triples() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(191); subject();
				setState(192); predicateObjectList();
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(195); subject();
				setState(196); predicateObjectList();
				setState(198); 
				_errHandler.sync(this);
				_alt = 1;
				do {
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(209); subject();
				setState(210); predicateObjectList();
	...
	public final BlankContext blank() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(228); blankNode();
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(229); blankNodePropertyList();
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(230); collection();
				}
				break;
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(231); blankNode();
	...
	public final BlankNodePropertyListContext blankNodePropertyList() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__11) | (1L << T__5) | (1L << T__4) | (1L << T__3) | (1L << KW_TRUE) | (1L << KW_FALSE) | (1L << RDF_TYPE) | (1L << IRIREF) | (1L << WRONGIRIREF) | (1L << PNAME_NS) | (1L << PNAME_LN) | (1L << BLANK_NODE_LABEL) | (1L << INTEGER) | (1L << DECIMAL) | (1L << DOUBLE) | (1L << STRING_LITERAL1) | (1L << STRING_LITERAL2) | (1L << STRING_LITERAL_LONG1) | (1L << STRING_LITERAL_LONG2) | (1L << WRONG_STRING_LITERAL_LONG2))) != 0)) {
				{
				{
				setState(238); predicateObjectList();
				}
				}
				setState(243);
				_errHandler.sync(this);
			...
			case 1:
				...
				while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
					if ( _alt==1 ) {
						{
						{
						setState(248); match(T__12);
						setState(249); predicate();
						setState(250); objectList();
						}
						} 
					}
					setState(256);
			...
			case 3:
				...
				while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
					if ( _alt==1 ) {
						{
						{
						setState(265); match(T__12);
						setState(266); predicate();
						setState(267); objectList();
						}
						} 
					}
					setState(273);
	...
	public final CollectionContext collection() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__11) | (1L << T__4) | (1L << T__3) | (1L << KW_TRUE) | (1L << KW_FALSE) | (1L << IRIREF) | (1L << WRONGIRIREF) | (1L << PNAME_NS) | (1L << PNAME_LN) | (1L << BLANK_NODE_LABEL) | (1L << INTEGER) | (1L << DECIMAL) | (1L << DOUBLE) | (1L << STRING_LITERAL1) | (1L << STRING_LITERAL2) | (1L << STRING_LITERAL_LONG1) | (1L << STRING_LITERAL_LONG2) | (1L << WRONG_STRING_LITERAL_LONG2))) != 0)) {
				{
				{
				setState(295); object();
				}
	...
	public final NumericLiteralContext numericLiteral() throws RecognitionException {
		...
		try {
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(323); match(DECIMAL);
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(324); match(DOUBLE);
				}
				break;
			case 4:
				enterOuterAlt(_localctx, 4);
	...
	public final RdfLiteralContext rdfLiteral() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				case LANGTAG:
					{
					setState(343); match(LANGTAG);
					}
					break;
				case T__13:
					{
					setState(344); match(T__13);
					setState(345); datatype();
					}
					break;
				case EOF:
				case T__12:
			...
			case 2:
				...
				case LANGTAG:
					{
					setState(349); match(LANGTAG);
					}
					break;
				case T__6:
					{
					setState(350); match(T__6);
					setState(351); datatype();
					}
					break;
				case EOF:
				case T__12:
			...
			case 3:
				...
				if (_la==LANGTAG) {
					{
					setState(357); match(LANGTAG);
					setState(358); match(T__13);
					setState(359); datatype();
					}
				}
	...
	public final StringContext string() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(377); match(STRING_LITERAL_LONG1);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(378); match(STRING_LITERAL_LONG2);
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(379); match(STRING_LITERAL_LONG2);
			...
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(382); match(T__4);
				setState(383); match(STRING_LITERAL_LONG2);
				notifyErrorListeners("Uncorrect form of long literal with 4 qoutes");
				}
				break;
			case 5:
				enterOuterAlt(_localctx, 5);
				{
				setState(385); match(WRONG_STRING_LITERAL_LONG2);
			...
			case 6:
				...
				{
				setState(387); match(STRING_LITERAL1);
				}
				break;
			case 7:
				enterOuterAlt(_localctx, 7);
				{
				setState(388); match(STRING_LITERAL2);
				}
				break;
			}
		}
	...
	public final IriContext iri() throws RecognitionException {
		...
		try {
			...
			case WRONGIRIREF:
				enterOuterAlt(_localctx, 1);
				{
				setState(391); match(WRONGIRIREF);
	...
	public final BlankNodeContext blankNode() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(399); match(BLANK_NODE_LABEL);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public