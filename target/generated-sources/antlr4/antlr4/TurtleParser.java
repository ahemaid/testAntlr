...
public class TurtleParser extends Parser {
	...
	public static final String[] tokenNames = {
		"<INVALID>", "'('", "')'", "'^^'", "';'", "'['", "','", "']'", "'^'", 
		"'.'", "KW_BASE", "KW_PREFIX", "'true'", "'false'", "PASS", "COMMENT", 
		"'@base'", "'@prefix'", "CODE", "'a'", "IRIREF", "PNAME_NS", "PNAME_LN", 
		"REGEXP", "REGEXP_FLAGS", "BLANK_NODE_LABEL", "LANGTAG", "INTEGER", "DECIMAL", 
		"DOUBLE", "STRING_LITERAL1", "STRING_LITERAL2", "STRING_LITERAL_LONG1", 
	...
	public final StartContext start() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__8) | (1L << T__4) | (1L << IRIREF) | (1L << PNAME_NS) | (1L << PNAME_LN) | (1L << BLANK_NODE_LABEL))) != 0)) {
					{
					{
					setState(60); triples();
					}
	...
	public final BaseSparqlContext baseSparql() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(78); match(KW_BASE);
			setState(79); match(IRIREF);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final BaseContext base() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(81); match(BASE);
				setState(82); match(IRIREF);
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(84); match(BASE);
				setState(85); match(IRIREF);
	...
	public final PrefixContext prefix() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(95); match(PREFIX);
				setState(96); match(PNAME_NS);
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(99); match(PREFIX);
				setState(100); match(PNAME_NS);
				setState(101); match(IRIREF);
	...
	public final PrefixSparqlContext prefixSparql() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(105); match(KW_PREFIX);
			setState(106); ((PrefixSparqlContext)_localctx).PNAME_NS = match(PNAME_NS);
			setState(107); ((PrefixSparqlContext)_localctx).IRIREF = match(IRIREF);
	...
	public final TriplesContext triples() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(110); subject();
			setState(111); predicateObjectList();
	...
	public final BlankContext blank() throws RecognitionException {
		...
		try {
			...
			case BLANK_NODE_LABEL:
				enterOuterAlt(_localctx, 1);
				{
				setState(118); blankNode();
				}
				break;
			case T__4:
				enterOuterAlt(_localctx, 2);
				{
				setState(119); blankNodePropertyList();
				}
				break;
			case T__8:
				enterOuterAlt(_localctx, 3);
				{
				setState(120); collection();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final BlankNodePropertyListContext blankNodePropertyList() throws RecognitionException {
		...
		try {
			...
			setState(124); predicateObjectList();
	...
	public final PredicateObjectListContext predicateObjectList() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(127); predicate();
			setState(128); objectList();
			setState(135);
			_errHandler.sync(this);
	...
	public final CollectionContext collection() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__8) | (1L << T__4) | (1L << KW_TRUE) | (1L << KW_FALSE) | (1L << IRIREF) | (1L << PNAME_NS) | (1L << PNAME_LN) | (1L << BLANK_NODE_LABEL) | (1L << INTEGER) | (1L << DECIMAL) | (1L << DOUBLE) | (1L << STRING_LITERAL1) | (1L << STRING_LITERAL2) | (1L << STRING_LITERAL_LONG1) | (1L << STRING_LITERAL_LONG2))) != 0)) {
				{
				{
				setState(155); object();
				}
	...
	public final BlankNodeContext blankNode() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(204); match(BLANK_NODE_LABEL);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public